 ...
 *
 * @dev Example:
 *   UintToUintPath=config/testnet/eid.json forge script script/UintToUintClone.s.sol --rpc-url $CHAIN_ID --private-key $DEPLOYER_KEY --etherscan-api-key $ETHERSCAN_KEY --broadcast
 */
