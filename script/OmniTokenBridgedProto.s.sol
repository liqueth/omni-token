...
/// @dev Usage: factory=io/$chain/OmniTokenBridgedFactory.json messaging=io/$chain/MessagingConfig.json bridge=io/$chain/MessagingConfig.json proto=io/$chain/OmniTokenBridgedProto.json forge script script/OmniTokenBridgedProto.s.sol -f $chain --private-key $tx_key --broadcast --verify --delay 10 --retries 10
