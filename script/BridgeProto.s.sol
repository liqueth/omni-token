...
/// @dev Usage: factory=io/$chain/BridgeFactory.json config=io/$chain/MessagingConfig.json proto=io/$chain/BridgeProto.json forge script script/BridgeProto.s.sol -f $chain --private-key $tx_key --broadcast --verify --delay 10 --retries 10
