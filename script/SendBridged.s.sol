...
/// @dev Example:
///   token=io/$chain/OmniTokenBridgedProto.json transfer=io/bridge.json forge script script/SendBridged.s.sol -f $chain --private-key $tx_key --broadcast
contract SendBridged is Script {
    struct Input {
        uint256 amount;
        uint256 toChain;
    }
